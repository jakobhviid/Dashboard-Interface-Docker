...
services:
  interface:
    ...
    environment: 
      ...
      DASHBOARDI_API_DNS: http://<<HOST_DNS>>:5000
...
- `DASHBOARDI_API_DNS`: When writing JSON Web Tokens, this value is used as the issuing Authority.
...
services:
  ...
  interface:
    ...
    environment:
      ...
      DASHBOARDI_JWT_KEY: cfeisecureJWTkey
      DASHBOARDI_API_DNS: http://<<SERVER1_DNS>>:5000
